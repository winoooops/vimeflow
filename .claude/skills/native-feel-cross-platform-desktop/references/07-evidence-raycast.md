...
- **Bundle identifier `com.raycast-x.macos`** is _distinct_ from the stable Raycast bundle ID. This is how Raycast ships a Beta and Stable side-by-side without collision — they're literally different apps from the OS's perspective.
