...
- `.github/workflows/nightly-release.yml` - read-only PR package verification,
  plus scheduled and manual Linux x64/macOS arm64 packaging, checksums,
  provenance generation, and gated publication to the rolling `nightly`
  prerelease
