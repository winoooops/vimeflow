...
- Scrollbars throughout the workspace — the editor pane, Diff Viewer, sidebar file panels, and agent-activity code previews — now use the design-system `thin-scrollbar` treatment (6px, transparent track, `#333344` thumb on hover-darkening). Several of these surfaces previously rendered the WebKit default scrollbar.
