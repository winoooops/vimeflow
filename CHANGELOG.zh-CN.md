...
- 将仓库内自主 harness、本地 `harness-plugin` marketplace 与旧 review
  辅助脚本替换为专用的 Lifeline Claude Code 插件工作流。根文档现在在
  `README.md`、`README.zh-CN.md` 与 `CLAUDE.md` 保留项目本地 Lifeline
  安装说明；不再在 `docs/` 下随仓库提供单独 Lifeline 文档。
