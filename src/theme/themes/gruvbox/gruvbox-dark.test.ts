...
test('gruvbox dark exposes the canonical dark palette mapping', () => {
  ...
  expect(gruvboxDark.ui['surface-container']).toBe('#524b46')
  expect(gruvboxDark.ui['surface-container-high']).toBe('#564f49')
  expect(gruvboxDark.ui['surface-container-highest']).toBe('#58504a')
  expect(gruvboxDark.ui['surface-bright']).toBe('#5a514a')
