...
export const SETTINGS_TARGET_IDS = {
  ...
  versionDiffViewStyle: 'version-diff-view-style',
  versionDiffTheme: 'version-diff-theme',
  versionDiffLineDiffType: 'version-diff-line-diff-type',
  versionDiffIndicators: 'version-diff-indicators',
  versionDiffOverflow: 'version-diff-overflow',
  versionDiffShowLineNumbers: 'version-diff-show-line-numbers',
  versionDiffBackgroundTint: 'version-diff-background-tint',
...
export const SETTINGS_TARGETS: SettingsTarget[] = [
  ...
  },
  {
    ...
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffTheme,
    section: 'version',
    label: 'Diff Theme',
    hint: 'Syntax theme used in hunk views.',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffLineDiffType,
    section: 'version',
    label: 'Intra-line Highlight',
    hint: 'Granularity used to highlight changes within a line.',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffIndicators,
    section: 'version',
    label: 'Change Indicators',
    hint: 'Markers shown beside added and removed lines.',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffOverflow,
    section: 'version',
    label: 'Long Lines',
    hint: 'Wrap or horizontally scroll long diff lines.',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffShowLineNumbers,
    section: 'version',
    label: 'Line Numbers',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffBackgroundTint,
    section: 'version',
    label: 'Background Tint',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffFileHeader,
    section: 'version',
    label: 'File Header',
    subsection: 'Hunk Appearance',
  },
  {
    id: SETTINGS_TARGET_IDS.versionDiffStickyHeader,
    section: 'version',
    label: 'Sticky Header',
    subsection: 'Hunk Appearance',
  },
