...
- `cost.total_lines_added: 0` and `cost.total_lines_removed: 0` — line deltas are sourced from the git-diff watcher for the global bottom `StatusBar`, not from Codex rollout JSON, so zeroes here are harmless.
...
| `cost.total_lines_added` / `total_lines_removed`           | always `0`                                                                                                                                              | Frontend line deltas are sourced from the git-diff watcher for the global bottom `StatusBar`; zeroes here are harmless.                                                                                                                                                                                              |
