...
pub fn generate_bridge_files(agent_status_dir: &str, session_id: &str) -> Result<BridgeFiles, String> {
    ...
    // Generate the statusline script. Use single quotes to prevent shell
    // injection from paths containing $(), backticks, or double quotes.
    ...
    // Single quotes prevent injection from paths with shell metacharacters.
